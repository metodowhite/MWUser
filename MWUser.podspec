...
Pod::Spec.new do |s|
  ...
  s.author             = { "elkraneo" => "cristian@metodowhite.com" }
  # s.authors          = { "elkraneo" => "cristian@metodowhite.com", "other author" => "email@address.com" }
  # s.author           = 'elkraneo', 'other author'
  # s.social_media_url = "http://twitter.com/elkraneo"
  ...
  s.source       = { :git => "https://github.com/metodowhite/MWUser.git", :tag => "0.0.1" }
